...
weather_api_token = '263aab873ab76ddd281f95e4e9c6cc03' # create account at https://darksky.net/dev/
...
class NewsHeadline(Frame):
    def __init__(self, parent, event_name=""):
        ...
        self.eventNameLbl = Label(self, text=self.eventName, font=('Helvetica', 13), fg="white", bg="black")
